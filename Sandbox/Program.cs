...
namespace ServerLauncher
{
    class Program
    {
        static void Main()
        {
            ...
            string[] Maps = new[] { // List of map names to get randomly chosen
                "fightspace3b",
                "gm_balkans",
                "gm_bigcity",
                "gm_bigisland",
            ...
            var proc = new ProcessStartInfo
            {
                ...
                Arguments = "+gamemode " + Gamemode + " -console +map " + Maps[randmap] + " +maxplayers " + MaxPlayers + " +r_hunkalloclightmaps 0",
